          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pe-4 pt-2">
              <Button size="lg" className="cursor-pointer">
                <a href="https://reactstarter.com/templates" className='flex items-center'>
                  Browse Templates
                  <ArrowRight className="ms-2 size-4" aria-hidden="true" />
                </a>
              </Button>
              <Button size="lg" variant="outline" className="cursor-pointer">
                <a href="https://reactstarter.com/blocks">
                  View Components
                </a>
              </Button>
            </div>
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-8 xl:gap-16">
          ...
          <div className="space-y-6 order-2 lg:order-1">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pe-4 pt-2">
              ...
              <Button size="lg" variant="outline" className="cursor-pointer">
                <a href="https://github.com/hassanprodeveloper/react-vite-shadcn-starter" target="_blank" rel="noopener noreferrer">
                  GitHub Repository
                </a>
              </Button>
            </div>
